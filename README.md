...
This is a simple and flexible implementation of a neural network ensemble that enables classification of the standard MNIST handwritten digit set, with a maximum observed accuracy of 96.75%.
